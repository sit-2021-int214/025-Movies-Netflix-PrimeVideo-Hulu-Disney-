...
1. อยากทราบว่าหนังที่ได้ทำการสำรวจมาทุกเรื่องมีค่าเฉลี่ยของคะแนน IMDb มีค่าเฉลี่ยเป็นเท่าไหร่ ?
2. อยากทราบว่าหนังที่ได้ทำการสำรวจมาทุกเรื่องมีค่าเฉลี่ยของคะแนน Rotten Tomatoes มีค่าเฉลี่ยเป็นเท่าไหร่ ?
3. อยากทราบจำนวนหนังที่ฉายในปี ค.ศ.1990 - ค.ศ.2000 ว่ามีทั้งหมดกี่เรื่อง ?
4. เนื่องจากใน streaming platforms มีผู้ชมหลากหลายวัย จึงอยากทราบว่าเรทหนังแต่ละช่วงอายุมีจำนวนทั้งหมดกี่เรื่อง ?
5. จากประเทศที่ไปสำรวจมาเราอยากทราบว่าประเทศ USA มีหนังที่รองรับมากกว่า 1 ภาษาอยู่กี่เรื่อง ?
6. อยากทราบว่าผู้กำกับที่มีชื่อว่า A.L. Vijay กำกับหนังมาแล้วกี่เรื่องและเรื่องอะไรบ้าง ?
...
| :--: | -------------------- | -----------     
| 1    | ...1                | ลำดับตัวเลขตั้งแต่ 0 - 9514 ซึ่งเป็นข้อมูลประเภท Numeric | 
...
### 4.1 Delete Column ###
1. ลบ column Type ออก เพราะว่าข้อมูลในตารางเป็น type movie หมด จึงแสดงค่าเป็น 0 ทั้งหมด
```
