...
| :--: | -------------------- | -----------     
| 1    | X                 | ลำดับตัวเลขตั้งแต่ 0 - 9514 | 
| 2    | ID                | รหัสของหนังแต่ละเรื่อง | 
| 3    | Title             | ชื่อของหนังแต่ละเรื่อง | 
| 4    | Year              | ปีที่เริ่มฉายหนังแต่ละเรื่อง | 
| 5    | Age               | เรทอายุของหนังแต่ละเรื่อง | 
| 6    | IMDb              | คะแนน IMDb ของหนังแต่ละเรื่องที่มีคะแนนสูงสุดคือ 10 คะแนน | 
| 7    | Rotten.Tomatoes   | คะแนน Rotten.Tomatoes ของหนังแต่ละเรื่องที่มีคะแนนสูงสุดคือ 100 คะแนน | 
| 8    | Netflix           | platform ที่ฉายหนัง โดยถ้า Netflix มีการฉายหนังเรื่องนั้น ก็จะแสดงเลข 1 | 
| 9    | Hulu              | platform ที่ฉายหนัง โดยถ้า Hulu มีการฉายหนังเรื่องนั้น ก็จะแสดงเลข 1 | 
| 10    | Prime.Video       | platform ที่ฉายหนัง โดยถ้า Prime.Video มีการฉายหนังเรื่องนั้น ก็จะแสดงเลข 1| 
| 11   | Disney.           | platform ที่ฉายหนัง โดยถ้า Disney. มีการฉายหนังเรื่องนั้น ก็จะแสดงเลข 1 | 
| 12   | Type              | บอกประเภทของหนังแต่ละเรื่องว่าเป็น movie หรือ series ถ้าเป็น movie จะแสดงเป็นเลข 0| 
| 13   | Directors         | ผู้กำกับหนังแต่ละเรื่อง | 
| 14   | Genres            | ประเภทของหนังแต่ละเรื่อง | 
| 15   | Country           | ประเทศที่ไปสำรวจคะแนน IMDb และ คะแนน Rotten.Tomatoes มา| 
| 16   | Language          | ภาษาที่รองรับหนังในแต่ละเรื่อง เช่น ภาษาอังกฤษ ภาษาเกาหลี | 
...
### 5.4.  เนื่องจากใน streaming platform มีผู้ชมหลากหลายวัย จึงอยากทราบว่าเรทหนังแต่ละช่วงอายุมีจำนวนทั้งหมดกี่เรื่อง ?
```
