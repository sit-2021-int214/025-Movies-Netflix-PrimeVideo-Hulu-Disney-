...
- Function `distinct()` ใช้ในการหาตัวไม่ซ้ำ ถ้าเจอตัวซ้ำตัดอ
...
- Function `top_n()` ใช้ในการหาท้อปหรือตัวที่สูงสุด
...
- Function `tally()` ใช้คล้ายๆการcount นับจำนวนข้อมูลนั้นๆ
...
2. หาสินค้าที่มียอดขายสูงสุด 10 อันดับ
...
3. แสดงชื่อสินค้าในแต่ละหมวดหมู่ย่อยและลูกค้าที่ซื้อสินค้านั้น

```
sale %>% group_by(sub_category) %>% select(product_name,sub_category,customer_name)
```
...
# Groups:   sub_category [17]
   product_name                                                     sub_category customer_name 
   <chr>                                                            <chr>        <chr>         
 1 Bush Somerset Collection Bookcase                                Bookcases    Claire Gute   
 2 Hon Deluxe Fabric Upholstered Stacking Chairs, Rounded Back      Chairs       Claire Gute   
 3 Self-Adhesive Address Labels for Typewriters by Universal        Labels       Darrin Van Hu~
 4 Bretford CR4500 Series Slim Rectangular Table                    Tables       Sean O'Donnell
 5 Eldon Fold 'N Roll Cart System                                   Storage      Sean O'Donnell
 6 Eldon Expressions Wood and Plastic Desk Accessories, Cherry Wood Furnishings  Brosina Hoffm~
 7 Newell 322                                                       Art          Brosina Hoffm~
 8 Mitel 5320 IP Phone VoIP phone                                   Phones       Brosina Hoffm~
 9 DXL Angle-View Binders with Locking Rings by Samsill             Binders      Brosina Hoffm~
10 Belkin F5C206VTEL 6 Outlet Surge                                 Appliances   Brosina Hoffm~
...
4. หาสินค้าและรายะเอียดของสินค้าที่อยู่ในหมวดหมู่เทคโนโลยี และต้องส่งไปที่เมืองเท็กซัส
...
5. หาสินค้าที่จะต้องส่งไปที่เมืองที่รหัสไปรษณีย์เลขมากกว่า 9400 และสินค้านั้นเป็นสินค้าที่มียอดขายมากกว่า 2,000
...
6. หาสินค้าที่ลูกค้าชื่อjoseph airdoเป็นคนสั่งซื้อ
...
7. อยากทราบจำนวนสินค้าที่ถูกขนส่งมาในแต่ละแบบ
